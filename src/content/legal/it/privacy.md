...
> Questo testo è una bozza di lavoro predisposta con il sito. Deve essere verificata e completata dall'agenzia, se necessario con il supporto di un consulente legale, prima della pubblicazione definitiva.

## Titolare del trattamento

Francorosso SA, Via Canova 19, 6900 Lugano, Svizzera.
E-mail: francorosso@francorosso.ch — Telefono: +41 91 923 60 92.
...
Utilizziamo i vostri dati esclusivamente per:
...
Per organizzare un viaggio è necessario trasmettere alcuni dati ai fornitori coinvolti: compagnie aeree, alberghi, operatori, assicuratori e autorità di frontiera quando richiesto. Comunichiamo solo i dati necessari a quella specifica prestazione. Alcuni di questi fornitori possono avere sede all'estero, anche in paesi che non garantiscono un livello di protezione equivalente a quello svizzero: in tal caso adottiamo le garanzie previste dalla legge.

## Per quanto tempo li conserviamo

Conserviamo le richieste non seguite da prenotazione per un periodo limitato, e i dati relativi a viaggi effettivamente prenotati per la durata prevista dagli obblighi contabili e fiscali svizzeri.
...
Il sito è servito tramite connessione cifrata. I messaggi inviati dai moduli vengono raccolti dal servizio di hosting e inoltrati alle caselle di posta dell'agenzia.
